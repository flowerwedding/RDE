...
% https://github.com/FTVarna/HIDMS-PSO
...
% 非线性递减惯性权重 - Sigmoid函数,从0.99非线性递减到0.2，使用S型曲线
w1 = 0.99 + (0.2-0.99)*(1./(1 + exp(-5*(2*(1:Tmax)/Tmax - 1)))); %nonlinear decrease inertia weight - Sigmoid function
c1=2.5-(1:Tmax)*2/Tmax;             % 个体学习因子：从2.5线性递减到0.5
c2=0.5+(1:Tmax)*2/Tmax;             % 社会学习因子：从0.5线性递增到2.5       
